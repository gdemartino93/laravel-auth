<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <span :messages="$errors->updatePassword->get('current_password')" class="mt-2" />
        </div>
        ...
        <div>
            ...
            <span :messages="$errors->updatePassword->get('password')" class="mt-2" />
        </div>
        ...
        <div>
            ...
            <span :messages="$errors->updatePassword->get('password_confirmation')" class="mt-2" />
        </div>
